...
const rawSk: Messages = {
  ...
  'actions.scrollUp': 'Posunúť hore',
  'actions.scrollDown': 'Posunúť dole',
  'actions.language': 'Jazyk',
  'service.menu.title': 'Servisné menu',
  'service.pinPrompt': 'Zadajte servisný PIN',
  'service.menu.close': 'Zavrieť',
  ...
  'qr.scanHeading': 'Naskenujte telefónom',
  'qr.scanHeadingFull': 'Naskenujte telefónom alebo aplikáciou',
  'qr.browserHint': 'Prípadne napíšte priamo do prehliadača:',
  'qr.paymentHint': 'Možnosti platby v prehliadači a aplikácii',
  ...
  'info.page.info-7.intro':
    'Stanica pozastavila nabíjanie (blokované stanicou). Príčina môže byť sieťová, tepelná alebo prevádzková.',
  ...
  'info.page.info-8.intro':
    'Stanica hlási chybu. Podľa typu chyby môže alebo nemusí prebiehať transakcia. Postupujte opatrne.',
  ...
  'connector.detail.rfid.lead': 'Registrovaní u {provider}: priložte platnú RFID kartu a nabíjanie sa spustí.',
  'connector.detail.rfid.roaming':
    'Bez registrácie u prevádzkovateľa môžete použiť eRoaming kartu operátorov: {list}.',
  'connector.detail.mobileCta': 'Spustiť mobilom',
  'connector.idle.startCta': 'Štart',
  'connector.detail.mobileHint': 'QR kód na štart cez aplikáciu',
  'connector.detail.priceMore': 'Ďalšie poplatky a podmienky',
  'connector.detail.priceLess': 'Skryť podrobnosti',
  'connector.detail.extraFees': 'Ďalšie poplatky',
  'connector.detail.rfidCta': 'Priložiť RFID kartu',
  ...
  'connector.session.title': 'Vozidlo',
  'connector.session.label.access': 'Prístup',
  'connector.session.label.vehicle': 'Vozidlo',
  'connector.session.label.plate': 'ŠPZ',
  'connector.session.label.driver': 'Vodič',
  'connector.session.label.credit': 'Kredit',
  'connector.session.emailShowFull': 'Zobraziť celú e-mailovú adresu',
  'connector.session.emailModalDismiss': 'Zavrieť',
  'connector.session.value.eroaming': 'eRoaming',
  'connector.session.value.paid': 'Spoplatnené',
  'connector.session.value.free': 'Bez poplatkov',
  'connector.session.value.private': 'Privátne',
  'connector.session.value.shared': 'Zdieľané',
  'connector.vehicleState.disconnected': 'Odpojené',
  'connector.vehicleState.waiting': 'Čaká',
  'connector.vehicleState.ready': 'Pripravené',
  'connector.session.loginHint': 'Prihláste sa kartou alebo PIN z transakcie.',
  'connector.session.pinButton': 'PIN',
  'connector.session.rfidSimulate': 'Karta (demo)',
  'connector.session.stop': 'Zastaviť nabíjanie',
  'connector.session.loginCta': 'Prihlásiť',
  'connector.session.noRegistration': 'Bez registrácie',
  'connector.session.endCharge': 'Ukončiť nabíjanie',
  'connector.session.pinTitle': 'PIN',
  'connector.session.pinHint': 'Kód zo začiatku nabíjania.',
  'connector.session.pinOk': 'Potvrdiť',
  'connector.session.pinBack': 'Zmazať',
  'connector.session.pinClose': 'Zavrieť',
  'connector.session.pinWrong': 'Nesprávny PIN',
  'connector.session.transactionPinOverlayTitle': 'PIN transakcie',
  'connector.session.transactionPinPrompt': 'Zadajte PIN transakcie',
  'connector.session.endChargeWait.loading': 'Ukončujeme nabíjanie na serveri…',
  'connector.session.endChargeWait.success': 'Nabíjanie bolo ukončené.',
  'connector.session.endChargeWait.error': 'Server neodpovedal správne. Skúste to znova.',
  'connector.session.endChargeWait.dismiss': 'Zavrieť',
  'connector.charging.timeTotal': 'Čas spolu',
  'connector.charging.timeCharging': 'Aktívne nabíjanie',
  'connector.charging.total': 'Spolu',
  'connector.charging.more': 'Viac',
  'connector.charging.less': 'Menej',
  'connector.charging.breakdown.kwh': 'Energia',
  'connector.charging.breakdown.parking': 'Parkovanie',
  'connector.charging.breakdown.session': 'Relácia',
  ...
  'access.mode': 'Režim:',
  'access.mode.free': 'Bez poplatkov',
  'access.mode.private': 'Neverejné',
  'access.mode.public': 'Verejné nabíjanie',
  'access.mode.paid': 'Spoplatnené',
  'access.mode.public_eroaming': 'Verejné + eRoaming',
  'access.free.hint': 'Nabíjacia stanica je v režime bezplatného nabíjania. Pripojte vozidlo a nabíjanie začne automaticky.',
  'access.private.hint': 'Nabíjať môžu iba vybraní používatelia definovaní majiteľom {owner}.',
  'access.eroaming.more': 'ďalší',
  ...
  'info.block.info-free.title': 'Bezplatné nabíjanie',
  'info.block.info-free.body':
    'Stanica umožňuje nabíjanie bez poplatkov za energiu podľa pravidiel majiteľa.',
  'info.page.info-free.intro':
    'Niektoré konektory môžu byť v režime bezplatného nabíjania – za odber energie sa v tomto režime neplatí podľa cenníka stanice.',
  'info.page.info-free.howto':
    '1. Pripojte kábel k vozidlu podľa pokynov na displeji.\n2. Ak stanica nevyžaduje autorizáciu, nabíjanie môže začať automaticky.\n3. Pravidlá môže upraviť majiteľ stanice (napr. len pre vybrané časy alebo miesta).',
  'info.page.info-free.important':
    'Bezplatné nabíjanie neznamená vždy „bez obmedzení“ – môžu platiť prevádzkové limity alebo podmienky majiteľa.',
  'info.page.info-free.locate': 'Na karte konektora v režime bez poplatkov uvidíte označenie a krátky popis; podrobnosti sú po ťuknutí na ikonu „i".',
  'info.block.info-pricing.title': 'Cenník a poplatky',
  'info.block.info-pricing.body':
    'Prehľad cien za nabíjanie vrátane poplatkov za reláciu, parkovanie a obsadenie miesta. V rozhraní kiosku sú sumy vždy uvedené vrátane DPH podľa krajiny, v ktorej prebieha nabíjanie.',
  'info.page.info-pricing.intro':
    'Na tejto stránke nájdete aktuálny cenník verejného nabíjania vrátane všetkých poplatkov. Zobrazené ceny na displeji obsahujú DPH podľa štátu nabíjania.',
  'info.page.info-pricing.howto':
    '1. Cena za kWh je uvedená pri každom konektore s verejným prístupom.\n2. Okrem ceny za energiu môžu byť účtované poplatky za reláciu, parkovanie a obsadenie miesta.\n3. Podrobnosti nájdete v karte konektora po kliknutí na ikonu „i".',
  'info.page.info-pricing.important':
    'Ceny sa môžu líšiť podľa konektora a typu prístupu. Pri eRoaming kartách určuje cenu poskytovateľ eRoaming služby.',
  'info.page.info-pricing.locate': 'Cenník nájdete na karte konektora v sekcii prístup a cenník.',
  'info.block.info-eroaming.title': 'eRoaming poskytovatelia',
  'info.block.info-eroaming.body':
    'Zoznam partnerských eRoaming poskytovateľov, ktorých karty sú akceptované na tejto stanici.',
  'info.page.info-eroaming.intro':
    'Táto stanica podporuje eRoaming – nabíjanie kartami partnerských poskytovateľov.',
  'info.page.info-eroaming.howto':
    '1. Priložte eRoaming kartu na čítačku.\n2. Stanica overí kartu u poskytovateľa.\n3. Po úspešnej autorizácii sa nabíjanie spustí automaticky.',
  'info.page.info-eroaming.important':
    'Cenu za nabíjanie určuje váš eRoaming poskytovateľ, nie prevádzkovateľ stanice.',
  'info.page.info-eroaming.locate': 'Zoznam akceptovaných poskytovateľov nájdete v karte konektora pod ikonou eRoaming.',
  ...
  'connector.overviewStatus.available': 'Voľný',
  'connector.overviewStatus.EVconnected': 'Vozidlo pripojené',
  'connector.overviewStatus.connectEV': 'Pripojte vozidlo',
  'connector.overviewStatus.preparing': 'Príprava',
  'connector.overviewStatus.charging': 'Nabíjanie',
  'connector.overviewStatus.suspendedEV': 'Ukončené',
  'connector.overviewStatus.suspendedEVSE': 'Blokované',
  'connector.overviewStatus.disconnectEV': 'Odpojte vozidlo',
  'connector.overviewStatus.suspended': 'Blokované',
  'connector.overviewStatus.finishing': 'Ukončovanie',
  'connector.overviewStatus.faultedWithTransa': 'Chyba',
  'connector.overviewStatus.faultedWithoutTransa': 'Chyba',
  'connector.overviewStatus.faulted': 'Chyba',
};
...
const rawEn: Messages = {
  ...
  'service.menu.title': 'Service menu',
  'service.pinPrompt': 'Enter service PIN',
  'service.menu.close': 'Close',
  ...
  'qr.scanHeading': 'Scan with your phone',
  'qr.scanHeadingFull': 'Scan with your phone or app',
  'qr.browserHint': 'Or type directly in your browser:',
  'qr.paymentHint': 'Payment options in browser and app',
  ...
  'connector.detail.rfid.lead': 'Registered with {provider}: tap a valid RFID card to start charging.',
  'connector.detail.rfid.roaming': 'Without registration, you can use an eRoaming card from: {list}.',
  'connector.detail.mobileCta': 'Start with phone',
  'connector.idle.startCta': 'Start',
  'connector.detail.mobileHint': 'QR code to start via app',
  'connector.detail.priceMore': 'Additional fees and terms',
  'connector.detail.priceLess': 'Hide details',
  'connector.detail.extraFees': 'Additional fees',
  'connector.detail.rfidCta': 'Tap RFID card',
  'connector.qrPay': 'QR to pay',
  'connector.moreInfo': 'More',
  'connector.tapHint': 'Tap for details',
  'connector.plugType.type2Outlet': 'Type 2 outlet',
  'connector.session.title': 'Vehicle',
  'connector.session.label.access': 'Access',
  'connector.session.label.vehicle': 'Vehicle',
  'connector.session.label.plate': 'Plate',
  'connector.session.label.driver': 'Driver',
  'connector.session.label.credit': 'Credit',
  'connector.session.emailShowFull': 'Show full email address',
  'connector.session.emailModalDismiss': 'Close',
  'connector.session.value.eroaming': 'eRoaming',
  'connector.session.value.paid': 'Paid',
  'connector.session.value.free': 'No fees',
  'connector.session.value.private': 'Private',
  'connector.session.value.shared': 'Shared',
  'connector.vehicleState.disconnected': 'Disconnected',
  'connector.vehicleState.waiting': 'Waiting',
  'connector.vehicleState.ready': 'Ready',
  'connector.session.loginHint': 'Sign in with card or session PIN.',
  'connector.session.pinButton': 'PIN',
  'connector.session.rfidSimulate': 'Card (demo)',
  'connector.session.stop': 'Stop charging',
  'connector.session.loginCta': 'Sign in',
  'connector.session.noRegistration': 'Not registered',
  'connector.session.endCharge': 'End charging',
  'connector.session.pinTitle': 'PIN',
  'connector.session.pinHint': 'Code from the start of charging.',
  'connector.session.pinOk': 'Confirm',
  'connector.session.pinBack': 'Delete',
  'connector.session.pinClose': 'Close',
  'connector.session.pinWrong': 'Wrong PIN',
  'connector.session.transactionPinOverlayTitle': 'Transaction PIN',
  'connector.session.transactionPinPrompt': 'Enter transaction PIN',
  'connector.session.endChargeWait.loading': 'Ending charging on the server…',
  'connector.session.endChargeWait.success': 'Charging has ended.',
  'connector.session.endChargeWait.error': 'The server did not respond correctly. Please try again.',
  'connector.session.endChargeWait.dismiss': 'Close',
  'connector.charging.timeTotal': 'Total time',
  'connector.charging.timeCharging': 'Active charging',
  'connector.charging.total': 'Total',
  'connector.charging.more': 'More',
  'connector.charging.less': 'Less',
  'connector.charging.breakdown.kwh': 'Energy',
  'connector.charging.breakdown.parking': 'Parking',
  'connector.charging.breakdown.session': 'Session',
  ...
  'pricing.occupy': 'Occupy fee:',
  'access.mode': 'Mode:',
  'access.mode.free': 'No fees',
  'access.mode.private': 'Non-public',
  'access.mode.public': 'Public charging',
  'access.mode.paid': 'Paid charging',
  'access.mode.public_eroaming': 'Public + eRoaming',
  'access.free.hint': 'Charging station is in free charging mode. Connect your vehicle and charging will start automatically.',
  'access.private.hint': 'Only selected users defined by the owner {owner} can charge.',
  'access.eroaming.more': 'more',
  ...
  'info.block.info-free.title': 'Free charging',
  'info.block.info-free.body':
    'The station may offer charging with no per-kWh fees under the owner’s rules.',
  'info.page.info-free.intro':
    'Some connectors can run in a no-fee mode—you are not charged for energy at the station’s public tariff in that mode.',
  'info.page.info-free.howto':
    '1. Plug in the cable as shown on screen.\n2. If no authorization is required, charging may start automatically.\n3. The owner may set limits (time windows, bays, or user groups).',
  'info.page.info-free.important':
    '“No fees” does not always mean “no limits”—operational rules from the owner may still apply.',
  'info.page.info-free.locate': 'On the connector card you will see the label and a short note; tap the “i” icon for details.',
  'info.block.info-pricing.title': 'Pricing and fees',
  'info.block.info-pricing.body':
    'Overview of charging prices including session, parking and occupancy fees. On the kiosk, amounts are always shown including VAT for the country where charging takes place.',
  'info.page.info-pricing.intro':
    'This page shows the current public charging prices including all applicable fees. On-screen amounts include VAT according to the country of charging.',
  'info.page.info-pricing.howto':
    '1. The per-kWh price is shown for each connector with public access.\n2. In addition to energy cost, session, parking and occupancy fees may apply.\n3. See connector card details by tapping the "i" icon.',
  'info.page.info-pricing.important':
    'Prices may differ by connector and access type. For eRoaming cards, the price is set by the eRoaming provider.',
  'info.page.info-pricing.locate': 'Pricing is shown on the connector card in the access and pricing section.',
  'info.block.info-eroaming.title': 'eRoaming providers',
  'info.block.info-eroaming.body':
    'List of partner eRoaming providers whose cards are accepted at this station.',
  'info.page.info-eroaming.intro':
    'This station supports eRoaming – charging with partner provider cards.',
  'info.page.info-eroaming.howto':
    '1. Tap your eRoaming card on the reader.\n2. The station verifies the card with the provider.\n3. Charging starts automatically after successful authorization.',
  'info.page.info-eroaming.important':
    'The charging price is set by your eRoaming provider, not the station operator.',
  'info.page.info-eroaming.locate': 'Accepted providers are listed on the connector card under the eRoaming icon.',
  ...
  'connector.overviewStatus.available': 'Available',
  'connector.overviewStatus.EVconnected': 'Vehicle connected',
  'connector.overviewStatus.connectEV': 'Connect vehicle',
  'connector.overviewStatus.preparing': 'Preparing',
  'connector.overviewStatus.charging': 'Charging',
  'connector.overviewStatus.suspendedEV': 'Ended',
  'connector.overviewStatus.suspendedEVSE': 'Blocked',
  'connector.overviewStatus.disconnectEV': 'Disconnect vehicle',
  'connector.overviewStatus.suspended': 'Blocked',
  'connector.overviewStatus.finishing': 'Finishing',
  'connector.overviewStatus.faultedWithTransa': 'Fault',
  'connector.overviewStatus.faultedWithoutTransa': 'Fault',
  'connector.overviewStatus.faulted': 'Fault',
};
...
const rawDe: Messages = {
  ...
  'actions.info': 'Info',
  'actions.support': 'Support',
  'actions.scrollUp': 'Nach oben scrollen',
  'actions.scrollDown': 'Nach unten scrollen',
  'actions.language': 'Sprache',
  'service.menu.title': 'Service-Menü',
  'service.pinPrompt': 'Service-PIN eingeben',
  'service.menu.close': 'Schließen',
  ...
  'qr.scanHeading': 'Mit dem Handy scannen',
  'qr.scanHeadingFull': 'Mit dem Handy oder der App scannen',
  'qr.browserHint': 'Oder direkt im Browser eingeben:',
  'qr.paymentHint': 'Zahlungsoptionen im Browser und App',
  ...
  'connector.detail.rfid.lead':
    'Bei {provider} registriert: Gültige RFID-Karte auflegen, um den Ladevorgang zu starten.',
  'connector.detail.rfid.roaming':
    'Ohne Registrierung können Sie eine eRoaming-Karte dieser Anbieter nutzen: {list}.',
  'connector.detail.mobileCta': 'Per Smartphone starten',
  'connector.idle.startCta': 'Start',
  'connector.detail.mobileHint': 'QR-Code zum Start über die App',
  'connector.detail.priceMore': 'Weitere Gebühren und Bedingungen',
  'connector.detail.priceLess': 'Details ausblenden',
  'connector.detail.extraFees': 'Weitere Gebühren',
  'connector.detail.rfidCta': 'RFID-Karte auflegen',
  'connector.qrPay': 'QR to pay',
  'connector.moreInfo': 'Mehr',
  'connector.tapHint': 'Tippen für Details',
  'connector.plugType.type2Outlet': 'Typ-2-Steckdose',
  'connector.session.title': 'Fahrzeug',
  'connector.session.label.access': 'Zugang',
  'connector.session.label.vehicle': 'Fahrzeug',
  'connector.session.label.plate': 'Kennzeichen',
  'connector.session.label.driver': 'Fahrer',
  'connector.session.label.credit': 'Guthaben',
  'connector.session.emailShowFull': 'Vollständige E-Mail-Adresse anzeigen',
  'connector.session.emailModalDismiss': 'Schließen',
  'connector.session.value.eroaming': 'eRoaming',
  'connector.session.value.paid': 'Kostenpflichtig',
  'connector.session.value.free': 'Kostenlos',
  'connector.session.value.private': 'Privat',
  'connector.session.value.shared': 'Geteilt',
  'connector.vehicleState.disconnected': 'Getrennt',
  'connector.vehicleState.waiting': 'Wartet',
  'connector.vehicleState.ready': 'Bereit',
  'connector.session.loginHint': 'Mit Karte oder Transaktions-PIN anmelden.',
  'connector.session.pinButton': 'PIN',
  'connector.session.rfidSimulate': 'Karte (Demo)',
  'connector.session.stop': 'Laden beenden',
  'connector.session.loginCta': 'Anmelden',
  'connector.session.noRegistration': 'Ohne Registrierung',
  'connector.session.endCharge': 'Laden beenden',
  'connector.session.pinTitle': 'PIN',
  'connector.session.pinHint': 'Code vom Ladebeginn.',
  'connector.session.pinOk': 'Bestätigen',
  'connector.session.pinBack': 'Löschen',
  'connector.session.pinClose': 'Schließen',
  'connector.session.pinWrong': 'Falsche PIN',
  'connector.session.transactionPinOverlayTitle': 'Transaktions-PIN',
  'connector.session.transactionPinPrompt': 'Transaktions-PIN eingeben',
  'connector.session.endChargeWait.loading': 'Ladevorgang wird auf dem Server beendet…',
  'connector.session.endChargeWait.success': 'Laden wurde beendet.',
  'connector.session.endChargeWait.error': 'Der Server hat nicht korrekt geantwortet. Bitte erneut versuchen.',
  'connector.session.endChargeWait.dismiss': 'Schließen',
  'connector.charging.timeTotal': 'Gesamtzeit',
  'connector.charging.timeCharging': 'Aktives Laden',
  'connector.charging.total': 'Gesamt',
  'connector.charging.more': 'Mehr',
  'connector.charging.less': 'Weniger',
  'connector.charging.breakdown.kwh': 'Energie',
  'connector.charging.breakdown.parking': 'Parken',
  'connector.charging.breakdown.session': 'Sitzung',
  ...
  'access.mode': 'Modus:',
  'access.mode.free': 'Kostenloses Laden',
  'access.mode.private': 'Nicht öffentlich',
  'access.mode.public': 'Öffentliches Laden',
  'access.mode.paid': 'Gebührenpflichtig',
  'access.mode.public_eroaming': 'Öffentlich + eRoaming',
  'access.free.hint': 'Die Ladestation befindet sich im kostenlosen Lademodus. Fahrzeug anschließen – Laden startet automatisch.',
  'access.private.hint': 'Nur ausgewählte Nutzer des Eigentümers {owner} können laden.',
  'access.eroaming.more': 'weitere',
  ...
  'info.block.info-free.title': 'Kostenloses Laden',
  'info.block.info-free.body':
    'Die Station kann Laden ohne kWh-Gebühren nach Regeln des Betreibers anbieten.',
  'info.page.info-free.intro':
    'Einige Stecker können im gebührenfreien Modus betrieben werden – für Energie fällt dann kein Stationspreis nach Tarif an.',
  'info.page.info-free.howto':
    '1. Kabel gemäß Anzeige anschließen.\n2. Ohne Autorisierung kann das Laden automatisch starten.\n3. Der Betreiber kann Einschränkungen setzen (Zeiten, Plätze, Nutzerkreise).',
  'info.page.info-free.important':
    '„Ohne Gebühren“ heißt nicht automatisch „ohne Regeln“ – betriebliche Vorgaben des Betreibers können gelten.',
  'info.page.info-free.locate': 'Auf der Steckerkarte sehen Sie Kennzeichnung und Kurztext; Details über das „i"-Symbol.',
  'info.block.info-pricing.title': 'Preise und Gebühren',
  'info.block.info-pricing.body':
    'Übersicht der Ladepreise einschließlich Sitzungs-, Park- und Belegungsgebühren. Am Kiosk werden Beträge immer inklusive MwSt. für das Land des Ladevorgangs angezeigt.',
  'info.page.info-pricing.intro':
    'Auf dieser Seite finden Sie aktuelle öffentliche Ladepreise einschließlich aller Gebühren. Angezeigte Beträge am Gerät enthalten die MwSt. gemäß Länderstandort.',
  'info.page.info-pricing.howto':
    '1. Der kWh-Preis wird bei jedem Stecker mit öffentlichem Zugang angezeigt.\n2. Neben Energiekosten können Sitzungs-, Park- und Belegungsgebühren anfallen.\n3. Details finden Sie auf der Steckerkarte über das „i"-Symbol.',
  'info.page.info-pricing.important':
    'Preise können je nach Stecker und Zugangsart variieren. Bei eRoaming-Karten bestimmt der eRoaming-Anbieter den Preis.',
  'info.page.info-pricing.locate': 'Preise finden Sie auf der Steckerkarte im Bereich Zugang und Preise.',
  'info.block.info-eroaming.title': 'eRoaming-Anbieter',
  'info.block.info-eroaming.body':
    'Liste der eRoaming-Partneranbieter, deren Karten an dieser Station akzeptiert werden.',
  'info.page.info-eroaming.intro':
    'Diese Station unterstützt eRoaming – Laden mit Karten von Partneranbietern.',
  'info.page.info-eroaming.howto':
    '1. Halten Sie Ihre eRoaming-Karte an das Lesegerät.\n2. Die Station prüft die Karte beim Anbieter.\n3. Nach erfolgreicher Autorisierung startet das Laden automatisch.',
  'info.page.info-eroaming.important':
    'Der Ladepreis wird von Ihrem eRoaming-Anbieter festgelegt, nicht vom Stationsbetreiber.',
  'info.page.info-eroaming.locate': 'Akzeptierte Anbieter finden Sie auf der Steckerkarte unter dem eRoaming-Symbol.',
  ...
  'connector.overviewStatus.available': 'Verfügbar',
  'connector.overviewStatus.EVconnected': 'Fahrzeug verbunden',
  'connector.overviewStatus.connectEV': 'Fahrzeug anschließen',
  'connector.overviewStatus.preparing': 'Vorbereitung',
  'connector.overviewStatus.charging': 'Laden',
  'connector.overviewStatus.suspendedEV': 'Beendet',
  'connector.overviewStatus.suspendedEVSE': 'Blockiert',
  'connector.overviewStatus.disconnectEV': 'Fahrzeug abstecken',
  'connector.overviewStatus.suspended': 'Blockiert',
  'connector.overviewStatus.finishing': 'Beenden',
  'connector.overviewStatus.faultedWithTransa': 'Fehler',
  'connector.overviewStatus.faultedWithoutTransa': 'Fehler',
  'connector.overviewStatus.faulted': 'Fehler',
};
...
const statusKeys: Record<ConnectorStatus, string> = {
  ...
  disconnectEV: toTpKey('connector.status.disconnectEV'),
...
const statusEn: Record<ConnectorStatus, string> = {
  ...
  disconnectEV: 'Disconnect vehicle',
  suspended: 'Suspended',
  finishing: 'Finishing',
...
const statusDe: Record<ConnectorStatus, string> = {
  ...
  disconnectEV: 'Fahrzeug abstecken',
  suspended: 'Pausiert',
  finishing: 'Beenden',
...
export type InfoBlockId = (typeof INFO_BLOCK_IDS)[number];
